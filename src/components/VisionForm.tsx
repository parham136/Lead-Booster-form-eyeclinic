...
export function VisionForm() {
  ...
  const handleLeadSubmit = async (data: {
    ...
    const webhookPromise = fetch('https://orbilo.app.n8n.cloud/webhook-test/vision-quiz', {
      method: 'POST',
      headers: {
  ...
  const handleBookConsultation = async () => {
    try {
      await fetch('https://orbilo.app.n8n.cloud/webhook-test/vision-quiz', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'ngrok-skip-browser-warning': 'true'
    ...
    window.location.href = 'https://orbilo.app.n8n.cloud/webhook-test/vision-quiz';
  };
